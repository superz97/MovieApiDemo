...
import com.superz.moviedemo.movie_detail.domain.model.Review
import com.superz.moviedemo.ui.home.component.MovieCard
import com.superz.moviedemo.ui.home.component.MovieCoverImage
        ...
        item {
            Card(
                ...
                Column(
                    ...
                    Row(
                        ...
                        Row(
                            ...
                            movieDetail.genreIds.forEachIndexed { index, genreText ->
                                ...
                                // Divider after all except the last element
                    ...
                    // Cast & Crew scrollable row
                    LazyRow {
                        items(movieDetail.cast) {
                            ActorItem(
                                cast = it,
                                modifier = Modifier.weight(1f).clickable { onActorClick(it.id) }
                            )
...
private fun Review(
    ...
    // Show more when a user needs more reviews
